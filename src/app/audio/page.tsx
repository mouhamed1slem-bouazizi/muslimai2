...
export default function AudioPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <Header compactTitle={titleText} showCompactTitle={showCompactHeader} transparent collapseProgress={collapseProgress} />
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-20 lg:pt-24">
        <h1
          ref={titleRef}
          className={`text-5xl md:text-4xl font-bold text-gray-900 dark:text-white mb-2 ${isRTL ? 'font-amiri' : ''} text-center transition-transform duration-200 origin-top`}
